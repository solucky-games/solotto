  ...
  <header class="sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3"  >
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="z-50 px-2 pt-2 pb-4  sm:flex sm:p-0">
      ...
      <div class="flex justify-center items-center rounded-xl">
        ...
        <!-- Dark Button -->
        <button class="rounded-full h-8 w-8 m-2 ml-4 sm:ml-0 flex justify-center items-center shadow-xl border " @click="dark=!dark; darkMode(dark)" :class="dark ? 'bg-white/10 border-white/20 hover:bg-gray-600 text-white' : 'bg-white hover:bg-gray-200 border-gray-100 text-gray-600'">
