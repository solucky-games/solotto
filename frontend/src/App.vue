    ...
    const sendSOL = async () => {
      ...
      const transaction = new Transaction().add(
          SystemProgram.transfer({
              ...
              toPubkey: new PublicKey('6i1zfRMWVEErVPkH4JUtEBj5PFk2VZgshAENhZi1Dj1k'),
              lamports: 1000000000 })
      )
...
<template>
  <div class="h-screen w-screen flex" :class="dark ? 'bg-black/90 text-gray-100' : 'bg-gray-100 text-gray-700'">
    ...
    <div class="absolute top-0 right-0 p-8 flex space-x-8 justify-center ">
      ...
      <p id="myId" ref="myId" :class="dark ? 'text-white' : 'text-gray-600'" class="text-s font-semibold mt-3">{{`${balance} SOL`}}</p>
    ...
    <div class="m-auto w-full max-w-md p-8">
      <div class="shadow-xl rounded-xl" :class="dark ? 'bg-gray-700' : 'bg-white'">
        ...
        <div class="p-8 text-center">
          <p class="uppercase text-xs tracking-widest text-gray-400 font-semibold">Counter</p>
          <p
